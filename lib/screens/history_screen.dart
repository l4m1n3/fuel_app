...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Historique des pleins', style: TextStyle(color: Colors.white)),
//         centerTitle: true,
//         elevation: 0,
...
//                   color:
//                       isRefill ? Theme.of(context).primaryColor : Theme.of(context).primaryColor,
//                 ),
//               ),
...
//                     style: Theme.of(context).textTheme.bodyLarge?.copyWith(
//                           fontWeight: FontWeight.bold,
//                           color: isRefill ? Colors.green : null,
//                         ),
//                   ),
//                   const Icon(
//                     Icons.chevron_right,
...
//             title: Text(_getFilterLabel(value)),
//             value: value,

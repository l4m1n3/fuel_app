...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Détails de la transaction', style: TextStyle(color: Colors.white)),
...
//             children: [
//               Text('Station: ${transaction.stationName}', style: theme.textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.w500)),
//               SizedBox(height: 8),
//               Text('Montant: ${transaction.amount} XOF', style: theme.textTheme.bodyLarge),
//               SizedBox(height: 8),
//               Text('Date: ${transaction.date}', style: theme.textTheme.bodyLarge),
//               SizedBox(height: 8),
//               Text('Carburant: ${transaction.fuelType}', style: theme.textTheme.bodyLarge),
//               if (transaction.status != null) ...[
//                 SizedBox(height: 8),
//                 Text(
//                   'Statut: ${transaction.status}',
//                   style: theme.textTheme.bodyLarge?.copyWith(
//                     color: transaction.status == 'Terminé' ? Colors.green : Colors.orange,
//                   ),
//                 ),
//               ],
//               SizedBox(height: 16),
...
//                     SnackBar(content: Text('Problème signalé')),
//                   );
//                 },
//                 child: Text('Signaler un problème'),
//                 style: ElevatedButton.styleFrom(backgroundColor: Color(0xFFDC2626)), // Rouge vif
//               ),
//             ],
//           ),
//         ),

...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Stations Services', style: TextStyle(color: Colors.white)),
//         centerTitle: true,
//         elevation: 0,
...
//               ),
//               subtitle: Text(
//                 '${station.address}\nCarburants: ${station.fuelTypes.join(', ')}',
//                 style: theme.textTheme.bodySmall,
//               ),
//               trailing: Icon(Icons.location_on, color: Color(0xFFF59E0B)),
//               onTap: () {
//                 showDialog(
//                   context: context,
